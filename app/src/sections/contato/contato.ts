export function criarElementoContato(){
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const botaoEnviar = document.querySelector("button.confirmar") as HTMLElement;
        const botaoRevisar = document.querySelector(".confirmacao button.confirmar") as HTMLElement;
        const elementoConfirma = document.querySelector(".confirmacao") as HTMLElement;
        const elementoBotoes = document.querySelector(".buttons-container") as HTMLElement;
